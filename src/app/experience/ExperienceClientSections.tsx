          ...
          <ScrollReveal delay={0.2}>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block border border-white/40 text-white/80 hover:bg-white/15 px-8 py-4 text-xs tracking-[0.2em] transition-all duration-500"
              >
                Googleフォームで予約
              </a>
            </div>
            <p className="text-xs text-white/40 mt-8 tracking-wide">
              Instagram DMでもお問い合わせいただけます
            </p>
          </ScrollReveal>
        </div>
      </section>
